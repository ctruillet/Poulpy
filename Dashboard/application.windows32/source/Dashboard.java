...
public void draw(){
  ...
  posBDE_x = posImg_x * 6.5f/4;
  posBDE_y = posImg_y * 17/11;  
  posSRI_x = posImg_x * 5.42f/4;
  posSRI_y = posImg_y * 17/11;
  posGC_x = posImg_x * 4.85f/4;
  posGC_y = posImg_y * 17/11;
  posSTRI_x = posImg_x * 4.92f/4;
  posSTRI_y = posImg_y * 13.72f;
  posDir_x = posImg_x *11.7f/11;
  posDir_y = posImg_y * 7.65f;  
...
public void init(){
  ...
  posImg_x = displayWidth/1.4f-image_sx/2;
...
public void showBDE(){
  ...
  fill(color(0,0,0,30));
  rect(40,displayHeight/6,2*displayWidth/5,2.2f*displayHeight/3);
  fill(color(0));
  textAlign(LEFT);
...
public void showAdmin(){
  ...
  fill(color(0,0,0,30));
  rect(40,displayHeight/6,2*displayWidth/5,2.7f*displayHeight/4);
  fill(color(0));
  textAlign(LEFT);
  textFont(generalFont,50);
...
public void showWeather(){
  ...
  fill(color(0,0,0,30));
  rect(40,displayHeight/6,2*displayWidth/5,1.15f*displayHeight/3);
  fill(color(0));
  textAlign(LEFT);
  textFont(generalFont,50);
  text("Météo :", 60, 270);
...
enum FSM{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Dashboard" };
    if (passedArgs != null) {
